...
Created with **NextJs**, **Typescrpt**, **TailwindCSS**, **NodeJS** and **Supabase**
...
the `layout.tsx` page holds all the UI content together. The homepage takes the data from content and displays and fetches it on the page for the user, there's search box and a togle to switch the languages available for thr articles
